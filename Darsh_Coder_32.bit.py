...
class Notepad: 
	...
	def __init__(self,**kwargs): 
		...
		# Set the window text 
		self.__root.title("Darsh Sharma - Coders 32-Bit")
	...
	def __showAbout(self): 
		showinfo("Help for all Coders","Hi All Coders i have make this Coding system and you can code java , javascript , HTML , css , C++ , C# , Python and more so you can run it using go to folder where you saved you (any) File and go to title and then backspace it and then write cmd open cmd and then write (your code file name) project name.your code file name) and just enter or make your file exe and for saveing your program you just go to file option and then go to save and save which file you want i will add runner faster there are some low files saver then 64-bit thanks Creater Darsh Sharma") 

	def __openFile(self): 
		
		self.__file = askopenfilename(defaultextension=".py" ".java" ".html" ".json" ".javascript" ".css" ".c++" ".c#" ".file" ".xml" ".darshpro",
									filetypes=[("Python Files","*.py"), ("Java Files","*.java"), ("HTML Files","*.html"), ("json Files","*.json"), ("JavaScript Files","*.javascript"), ("css Files","*.css"), ("C++ Files","*.c++"), ("C# Files","*.c#"), ("File","*.file"), ("XML Files","*.xml"), ("DarshPro Files","*.darshpro"),
										("All Files","*.*")]) 
	...
	def __saveFile(self): 
		...
		if self.__file == None: 
			...
			self.__file = asksaveasfilename(initialfile='Darsh Coders.py', 
											defaultextension=".py" ".java" ".html" ".json" ".javascript" ".css" ".c++" ".c#" ".file" ".xml" ".darshpro", 
											filetypes=[("Python Files","*.py"), ("Java Files","*.java"), ("HTML Files","*.html"), ("json Files","*.json"), ("JavaScript Files","*.javascript"), ("css Files","*.css"), ("C++ Files","*.c++"), ("C# Files","*.c#"), ("File","*.file"), ("XML Files","*.xml"), ("DarshPro Files","*.darshpro"),
												("All Files","*.*")]) 
